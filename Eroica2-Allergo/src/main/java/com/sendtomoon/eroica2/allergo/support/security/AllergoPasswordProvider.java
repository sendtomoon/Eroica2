...
import com.sendtomoon.eroica.common.security.PasswordCodeUtils;
import com.sendtomoon.eroica.common.security.PasswordContext;
import com.sendtomoon.eroica.common.security.PasswordProvider;

public class AllergoPasswordProvider implements PasswordProvider {

	protected Log logger = LogFactory.getLog(AllergoPasswordProvider.class);

	public static final String KEY_NAMESPACE = "allergo.password.provider.namespace";

	private static final String ALLERGO_GROUP = "passwords";

	public AllergoPasswordProvider() {
	...
	public String getPassword(PasswordContext context) {
		...
		try {
			...
			String value = com.sendtomoon.eroica2.allergo.Allergo.getManager().get(ALLERGO_GROUP, key);
