...
import com.sendtomoon.eroica2.common.Eroica;
import com.sendtomoon.eroica2.common.utils.EroicaMeta;
import com.sendtomoon.eroica2.common.utils.InstanceSystemPropertyUtils;
import com.sendtomoon.eroica2.common.utils.NetUtils;
...
public class AllergoInitializer extends PropertyPlaceholderConfigurer implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		try {
			...
			throw new AllergoException("Pizza startup failure ,cause:" + th.getMessage(), th);
		}
	}
	...
	protected synchronized void doInit() {
		...
		startupLogger.info("Pizza configure initialized,primary properties:" + info);
	}
