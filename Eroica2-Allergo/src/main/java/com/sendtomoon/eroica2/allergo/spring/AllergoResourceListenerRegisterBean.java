...
public class AllergoResourceListenerRegisterBean extends ApplicationObjectSupport
	...
	public AllergoContext getAllergoContext() {
		if (allergoContext == null) {
			allergoContext = com.sendtomoon.eroica2.allergo.Allergo.getAllergoContext();
		}
		return allergoContext;
	}

	public void setAllergoContext(AllergoContext allergoContext) {
