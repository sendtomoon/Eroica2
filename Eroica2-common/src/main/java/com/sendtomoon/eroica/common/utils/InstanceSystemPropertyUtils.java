...
public class InstanceSystemPropertyUtils {
	...
	public static final String KEY_INSTANCE_IP = "eroica.instance.ip";

	public static final String KEY_INSTANCE_NAME = "eroica.instance.name";

	private static final String KEY_INSTANCE_ID = "eroica.instance.id";
